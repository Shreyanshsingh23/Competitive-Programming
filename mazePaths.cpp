...
//     v<string> hpaths = rec(x1, y1+1);
//     v<string> vpaths = rec(x1+1, y1);
...
int rec(int x1, int y1){
    ...
    int hpaths = rec(x1, y1+1);
    int vpaths = rec(x1+1, y1);
   
    int paths = hpaths + vpaths;
