...
string s;
set<pi> vis = {};
// f(l,r,sum) -> returns the number of good subarrays including elements form range [l...r]
int f(int l, int r, vi& pref)
{
    if(l == n or r == n)return 0;
    if(l > r)return 0;

    if(vis.count({l,r}))return 0;
