...
struct segmentTree {
    ...
    int mn(int x, int lx, int rx, int l, int r) {
        ...
        int ans1 = mn(x * 2 + 1, lx, mid, l, r);
        int ans2 = mn(x * 2 + 2, mid, rx, l, r);
        
        return min(ans1, ans2);
    }

    int mn(int l, int r) {
        return mn(0, 0, size, l, r);
    }
